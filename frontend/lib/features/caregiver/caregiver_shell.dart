...
class _CaregiverBottomNavBar extends StatelessWidget {
  ...
  ///
  /// Every destination shares the same selected colour, matching the
  /// patient side's single-accent bar — a colour per tab read as five
  /// unrelated controls rather than one bar.
